...
function Landpage() {
  ...
  return (
    <div className=" overflow-x-hidden  text-[#e0c49c]">
      {isMobile ? (
        <>
          <div className="w-full h-[90vh] mt-10 flex flex-col justify-between items-center">
            ...
            <div className="h-full w-3/6 flex flex-col md:items-end items-center justify-center">
            ...
            <div className="px-5 pb-10 h-full flex flex-col justify-end">
        ...
        <>
          <div className="w-full h-[90vh]  flex md:flex-row flex-col justify-between items-center">
            <div
              ...
              className="h-full w-3/6 flex flex-col md:items-start items-center justify-center"
            >
              <motion.h1
              ...
              <motion.a
                animate={hoverstate === 1 ? { y: -50, x: 0 } : { x: "-100vw" }}
                initial={{ x: "-100vw" }}
            ...
            <div
              ...
              onMouseLeave={() => setHoverstate(0)}
              className="h-full w-3/6 flex flex-col md:items-end items-center justify-center"
            >
              <motion.h1
              ...
              <motion.a
                animate={hoverstate === 2 ? { y: -50, x: 0 } : { x: "100vw" }}
                initial={{ x: "100vw" }}
                className="font-thin text-3xl"
                href="/#"
              >
              ...
              <div
                className={`${hoverstate == 2 ? "rotate-45" : ""} duration-200`}
              >
                <svg
                  className=""
                  width="100"
