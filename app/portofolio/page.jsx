    ...
    return (
        <div className='bgl md:px-20 p-10 text-white'>
            ...
            <div className='md:flex grid grid-cols-1 gap-2 justify-between z-20'>
                ...
                <button onClick={() => setComp(1)} className={`${comp == 1 ? "md:translate-y-3 border-2 md:border-b-0 border-[#00F0FF]  py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out" : " py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out"}`}>
                    <p className={`${comp == 1 ? "text-xl txt1" : "txt1d duration-100 ease-in-out"}`}>Game and Simulation
                    </p>
                </button>
                <button onClick={() => setComp(2)} className={`${comp == 2 ? "md:translate-y-3 border-2 md:border-b-0 border-[#00F0FF]  py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out" : " py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out"}`}>
                    <p className={`${comp == 2 ? "text-xl txt1" : "txt1d duration-100 ease-in-out"}`}>Art and illustration
                    </p>
                </button>
                <button onClick={() => setComp(3)} className={`${comp == 3 ? "md:translate-y-3 border-2 md:border-b-0 border-[#00F0FF]  py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out" : " py-3 bgd w-full h-full flex justify-center items-center duration-100 ease-in-out"}`}>
